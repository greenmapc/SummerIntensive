...
<@l.layout "Передача автомобиля. Водитель -> Компания" "">
    ...
    <div class="form-container flex__form layout-positioner">
        <h1 class="form-container__h1 flex__element">Акт приёма-передачи автомобиля <br>от водителя к компании</h1>
        ...
        <div class="flex__container">
            <form class="form-container__form" action="/user/create_act_from_driver_to_company" method="post">
                ...
                <@spring.formSingleSelect "formDC.auto" autos 'class="auto_select form-container__form--input flex__element"
                        id="document__auto" placeholder="Выберите авто"'/>
                <br>

                <label for="document__driver">Водитель (кто передаёт)*</label><br>
                <@spring.formSingleSelect "formDC.renter" drivers 'class="driver_select form-container__form--input flex__element"
