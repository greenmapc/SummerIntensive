...
<head>
    <meta charset="UTF-8">
    <title>TaxiService. Добавление водителя</title>
...
<div class="form-container flex__container layout-positioner">
    ...
    <form class="form-container__form" action="/operator/create_driver" method="post">
        ...
        <input class="form-container__form--input flex__element" type="date" id="driver__date_of_driver_license_issue"
               name="dateOfDriverLicenseIssue"
               placeholder="" required><br>

        <label for="driver__date_of_driver_license_expiry">Дата окончания действия ВУ</label><br>
        <input class="form-container__form--input flex__element" type="date" id="driver__date_of_driver_license_expiry"
