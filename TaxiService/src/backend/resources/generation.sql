...
insert into driver (actual_address, black_list, date_of_passport_issue, drivers_license_series, drivers_license_number,
                    first_name, last_name, passport_number, passport_series, patronymic, phone_number, place_of_passport_issue,
                    rating, residence_address, date_of_license_expiry, date_of_license_issue, birth_date)
